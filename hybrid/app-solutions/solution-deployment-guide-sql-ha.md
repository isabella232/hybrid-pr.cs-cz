...
---
# <a name="deploy-a-sql-server-2016-availability-group-across-two-azure-stack-hub-environments"></a>Nasazení skupiny dostupnosti SQL Server 2016 ve dvou prostředích centra Azure Stack
